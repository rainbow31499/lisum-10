...
# A sample data of 30000000 observations of soil temperatures taken at 538 locations around the world

random.seed(1030)

indices = list(range(30000000))

location = [random.randrange(1,539) for i in indices]
location_temperature = {i:random.uniform(-10,30) for i in range(1,5393)}
